...
#
# If financial markets were perfectly "efficient", past returns would tell you nothing
...
# autocorrelation -- big moves cluster together. Squaring the returns removes the sign (+/-)
