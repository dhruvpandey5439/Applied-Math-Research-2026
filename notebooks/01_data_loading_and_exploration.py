...
ticker = "^GSPC"
data = yf.download(ticker, start="2000-01-01", end="2026-06-01") #Download S&P 500 data
...
data.to_csv("sp500_raw.csv") # Saves raw data
...
print(data.describe()) #Helps detect anomalies
...
plt.xlabel("Date")                                                          #This is my non stationary series or pirces that trend upward over time
plt.ylabel("Price")
plt.grid(alpha=0.3)
...
# This is roughly stationary or hovers around a constant mean/variance,
